...
import 'package:random_video_call/utils/settings.dart';
...
class _CallPageState extends State<CallPage> {
  ...
  Widget _panel() {
   ...
   void _onCallEnd(BuildContext context) async{
     ...
     await Firestore.instance.collection("Users").document(widget.channelName).updateData({
      "callStatus": false,
    });
    DatabaseService().updateCallingStatus(callFromId: null, callToId: widget.userId);
